class Play extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('spaceship',"./assets/boat.png");
        this.load.spritesheet('explosion', './assets/sinking.png',{frameWidth: 64,frameHeight: 32, startFrame: 0, endFrame: 9});
    ...
    create() {
        ...
        this.bgm = this.sound.add('play_music', {
            mute: false,
            volume: 0.1,
            rate: 1,
            loop: true
